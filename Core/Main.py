...
def main(page: Page):
    ...
    def color_change(e):
        ...
        global color
        color = choice(_color)
        banner.controls = [Text(spans=[TextSpan('FAST BOOMB', TextStyle(size=95, foreground=Paint(color=color, stroke_width=9, stroke_join='round', style='stroke')))], font_family='Consolas'), Text(spans=[TextSpan('FAST BOOMB', TextStyle(size=95, color=color))], font_family='Consolas')]
    ...
    # Баннер
    banner = Stack([Text(spans=[TextSpan('', TextStyle(size=95, foreground=Paint(color=color, stroke_width=9, stroke_join='round', style='stroke')))], font_family='Consolas'), Text(spans=[TextSpan('FAST BOOMB', TextStyle(size=95, color=color))], font_family='Consolas')])
    ...
    def ADD():
        ...
        page.add(
                ...
                attack_button,
                Text('\n', size=12),
                Row([IconButton(icon='discord', icon_size=48, tooltip='Канал', url='https://discord.gg/cj5fgSVDMv', icon_color=color),
